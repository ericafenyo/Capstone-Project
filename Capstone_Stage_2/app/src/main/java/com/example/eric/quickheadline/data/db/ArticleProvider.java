 ...
 * data, query all data, and delete all data.Additional methods to perform single inserts and
 * single deletes are not implemented because they are not needed.
 */
...
public class ArticleProvider extends ContentProvider {
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        final String authority = QHContracts.ARTICLE_CONTENT_AUTHORITY;

        /* This URI is content://com.example.eric.quickheadline/article */
        matcher.addURI(authority, QHContracts.PATH_ARTICLE, CODE_LATEST_ARTICLE);
