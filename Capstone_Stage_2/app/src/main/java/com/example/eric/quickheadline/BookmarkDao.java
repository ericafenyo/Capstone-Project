...
public interface BookmarkDao {
    ...
    @Query("SELECT * FROM bookmark WHERE publishedAt IN (:linkUrls)")
    List<Bookmark> gueryByPrimaryKey(String linkUrls);

    @Query("DELETE FROM bookmark WHERE publishedAt IN (:linkUrls)")
    void deleteItem(String linkUrls);
